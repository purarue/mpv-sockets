...
In contrast to [`mpv-next-song`](./mpv-next-song), if you were watching some TV show episode and wanted to watch the next one, but started `mpv` with only the one file, I have [a script to open the next file and quit the old `mpv` instance](https://github.com/purarue/dotfiles/blob/05e7939f7876e8494ad34fcc9accb3562fd63409/.config/zsh/aliases/project_aliases#L248-L277)
